...
public class CHScrobbler {
    private static final Logger logger = LoggerFactory.getLogger(CHScrobbler.class);;
    ...
    public static void main(String[] args) {
        try {
            ...
            if(session == null) {
                JOptionPane.showMessageDialog(null,"Unable to establish connection with last.fm! Please make sure your config.txt details are correct!", "last.fm init error!", JOptionPane.ERROR_MESSAGE);
            } else {
